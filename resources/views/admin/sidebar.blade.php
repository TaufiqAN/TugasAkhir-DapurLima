 ...
 <aside id="logo-sidebar" class=" fixed bottom-4 overflow-y-auto transition-all duration-300 z-40 w-72 h-screen -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-white">
      ...
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <a href="/reviews" class="flex items-center p-2 text-gray-900 rounded-lg hover:text-gray-100 dark:hover:bg-green-700 group {{ request()->routeIs('admin.reviews') ? 'bg-green-700 text-white' : '' }}">
               <svg class="shrink-0 w-5 h-5 transition duration-75 group-hover:text-white " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
         ...
         <li>
            <a href="/users" class="flex items-center p-2 text-gray-900 rounded-lg hover:text-gray-100 dark:hover:bg-green-700 group {{ request()->routeIs('admin.users') ? 'bg-green-700 text-white' : '' }}">
               <svg class="shrink-0 w-5 h-5 transition duration-75 group-hover:text-white " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
