       ...
       <ul class="space-y-2 font-medium">
          ...
          <li>
             <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg hover:text-gray-100 hover:bg-green-700 group">
                <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 17 18">
          ...
          <li>
             <a href="/logout" class="flex items-center p-2 text-gray-900 rounded-lg hover:text-gray-100 dark:hover:bg-green-700 group">
