...
<section class="bg-gray-100  flex items-center h-screen  justify-center">
            ...
            <div class="w-[500px] p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl">
                ...
                <form class="mt-8 space-y-6" action="/login" method="POST">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="name@gmail.com" />
                    ...
                    {{-- Button  --}}
                    <button type="submit" class="min-w-full px-5 rounded-lg py-3 text-base font-medium text-center text-white sm:w-auto bg-green-600 hover:bg-green-700">Login</button>
                    <div>
