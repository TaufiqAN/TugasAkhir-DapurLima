...
<section class="bg-gray-50 flex items-center justify-center min-h-screen px-4">
    <div class="py-8 px-4 mx-auto max-w-screen-xl w-full sm:w-[500px] lg:py-16 gap-8 lg:gap-16">
        <div class="w-full p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl">
            ...
            <form class="mt-8 space-y-6" action="/register" method="POST">
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" id="togglePassword" class="absolute inset-y-0 right-3 flex items-center">
                            <svg id="eyeIcon" class="w-5 h-5 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none"
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" id="toggleConfirmPassword" class="absolute inset-y-0 right-3 flex items-center">
                            <svg id="eyeIconConfirm" class="w-5 h-5 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" />
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                {{-- Button --}}
                <button type="submit"
                    class="min-w-full px-5 py-3 text-base font-medium text-center text-white bg-green-600 rounded-lg hover:bg-green-700 focus:ring-4 focus:ring-blue-300 sm:w-auto">
                    Buat akun
                </button>
                ...
                <div>
                    <a href="/auth-google-redirect">
                        <button type="button"
                            class="text-center inline-flex items-center justify-center min-w-full px-5 py-3 text-base font-medium text-gray-600 hover:text-white bg-white rounded-lg hover:bg-gray-800 sm:w-auto border border-black bg-transparent transition-all duration-300 ease-in-out hover:shadow-lg">
